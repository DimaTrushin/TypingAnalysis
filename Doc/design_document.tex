...
The Seance is presented by \verb"CSeance" class (TO DO not implemented) and Session by \verb"CSession" class (TO DO not implemented).
...
\item \verb"CurrentSeance". (TO DO not implemented yet) Current seance stores all sessions.
...
\begin{enumerate}
\item \verb"makeSeances" (TO DO not implemented yet). This modifies RawSessions from SeanceMaker  to Sessions and put them into CurrentSeance.
