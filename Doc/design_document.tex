...
When started the application intercepts keyboard events system-wide, translates them into OS independent form and shows the debug output via \verb"qDebug()". If debugging macros are enabled~\ref{section::Debugging}, additional debugging windows are shown to output debug information.
